...
jQuery(document).ready(function ($) {
    ...
    // Initial function for checking cache
    mashsb_check_cache();
 ...
 /**
    ...
    function responsiveButtons()
    {
        ...
        function getAverageWidth()
        {
            ...
            console.log('container' + $container[0].getBoundingClientRect().width);
            

            // Share counter is visible
            if (isShareCountContainerVisible === true) {
                totalUsedWidth += $shareCountContainer.outerWidth(true);
                console.log('share count: ' + $shareCountContainer.outerWidth(true));
            }

            // View counter is visible
            if (isViewCounterContainerVisible === true) {
                totalUsedWidth += $viewCounterContainer.outerWidth(true);
                console.log('view count: ' + $viewCounterContainer.outerWidth(true));
            }

            // Plus button is visible
            if (isPlusButtonVisible === true) {
                totalUsedWidth += $plusButton.outerWidth(true);
                console.log('width plus button' + $plusButton.outerWidth());
            }
            
            console.log('totalUsedWidth' + totalUsedWidth);
            
            console.log('initial button amount' + $primaryButtons.length);
            ...
            console.log('averageWidth calculated' + averageWidth);
            console.log('buttons width incl. margin' + $primaryButtons.first().outerWidth(true) );
            console.log('buttons width excl. margin' + $primaryButtons.first().outerWidth() );
            console.log('margin:' + ($primaryButtons.first().outerWidth(true) - $primaryButtons.first().outerWidth()));
            ...
            // Floor it down
            averageWidth = floorDown(averageWidth, 0);

            console.log('right width without margin' + averageWidth)
            return averageWidth;
        }
    }
