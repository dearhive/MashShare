...
class MASHSB_HEADER_META_TAGS {
    ...
    public function render_twitter_card_meta() {
        ...
        if( !empty( $this->get_og_image_size()[0] ) ) {
            $twittercard .= PHP_EOL . '<meta property="og:image:width" content="' . $this->get_og_image_size()[0] . '" />';
            $twittercard .= PHP_EOL . '<meta property="og:image:height" content="' . $this->get_og_image_size()[1] . '" />';
        }
