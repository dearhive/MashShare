	...
	public function admin_notice() {
		...
		if(
			...
			echo '<div class="updated"><p>';
				echo sprintf( __( 'Allow Mashshare to track plugin usage? Opt-in to tracking and our newsletter and immediately be emailed a 10%% discount to the Mashshare shop, valid towards the <a href="%s" target="_blank">purchase of Add-Ons</a>. No sensitive data is tracked.', 'mashsb' ), $extensions_url );
