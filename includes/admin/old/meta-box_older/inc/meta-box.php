...
class RW_Meta_Box
{
	...
	function admin_enqueue_scripts()
	{
		...
		foreach ( $fields as $field )
		{
			if ( $field['clone'] )
			{
				wp_enqueue_script( 'rwmb-clone', MASHSB_RWMB_JS_URL . 'clone.js', array( 'jquery-ui-sortable' ), MASHSB_RWMB_VER, true );
				break;
			}
		}
		...
		if ( $this->meta_box['autosave'] )
			wp_enqueue_script( 'rwmb-autosave', MASHSB_RWMB_JS_URL . 'autosave.js', array( 'jquery' ), MASHSB_RWMB_VER, true );
