...
class MASHSB_RWMB_Color_Field extends MASHSB_RWMB_Text_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-color', MASHSB_RWMB_CSS_URL . 'color.css', array( 'wp-color-picker' ), MASHSB_RWMB_VER );
		wp_enqueue_script( 'rwmb-color', MASHSB_RWMB_JS_URL . 'color.js', array( 'wp-color-picker' ), MASHSB_RWMB_VER, true );
	}
