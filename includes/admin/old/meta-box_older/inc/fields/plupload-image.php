 ...
 */
class MASHSB_RWMB_Plupload_Image_Field extends MASHSB_RWMB_Image_Field
{
	/**
	 * Add field actions.
	 */
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_style( 'rwmb-plupload-image', MASHSB_RWMB_CSS_URL . 'plupload-image.css', array( 'wp-admin' ), MASHSB_RWMB_VER );
		wp_enqueue_script( 'rwmb-plupload-image', MASHSB_RWMB_JS_URL . 'plupload-image.js', array( 'jquery-ui-sortable', 'wp-ajax-response', 'plupload-all' ), MASHSB_RWMB_VER, true );
		wp_localize_script( 'rwmb-plupload-image', 'RWMB', array( 'url' => MASHSB_RWMB_URL ) );
	}
