...
class MASHSB_RWMB_Map_Field extends MASHSB_RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_style( 'rwmb-map', MASHSB_RWMB_CSS_URL . 'map.css' );
		wp_enqueue_script( 'rwmb-map', MASHSB_RWMB_JS_URL . 'map.js', array( 'jquery-ui-autocomplete', 'google-maps' ), MASHSB_RWMB_VER, true );
	}
	...
	static function the_value( $field, $args = array(), $post_id = null )
	{
		...
		$google_maps_url = apply_filters( 'rwmb_google_maps_url', 'https://maps.google.com/maps/api/js?sensor=false' );
		wp_register_script( 'google-maps', esc_url_raw( $google_maps_url ), array(), '', true );
		wp_enqueue_script( 'rwmb-map-frontend', MASHSB_RWMB_JS_URL . 'map-frontend.js', array( 'google-maps' ), '', true );
