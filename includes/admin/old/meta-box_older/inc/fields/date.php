 ...
 * Date field class.
 */
class MASHSB_RWMB_Date_Field extends MASHSB_RWMB_Text_Field
{
	/**
	 * Get field HTML
	 *
	...
	static function admin_enqueue_scripts()
	{
		...
		{
			if ( file_exists( MASHSB_RWMB_DIR . 'js/' . $file_path ) )
			{
				wp_register_script( 'jquery-ui-datepicker-i18n', MASHSB_RWMB_JS_URL . $file_path, $deps, '1.8.17', true );
				$deps[] = 'jquery-ui-datepicker-i18n';
				break;
			}
		}

		wp_enqueue_script( 'rwmb-date', MASHSB_RWMB_JS_URL . 'date.js', $deps, MASHSB_RWMB_VER, true );
	}
