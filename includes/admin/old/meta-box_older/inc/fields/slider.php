...
class MASHSB_RWMB_Slider_Field extends MASHSB_RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_style( 'rwmb-slider', MASHSB_RWMB_CSS_URL . 'slider.css' );

		wp_enqueue_script( 'rwmb-slider', MASHSB_RWMB_JS_URL . 'slider.js', array( 'jquery-ui-slider', 'jquery-ui-widget', 'jquery-ui-mouse', 'jquery-ui-core' ), MASHSB_RWMB_VER, true );
	}
