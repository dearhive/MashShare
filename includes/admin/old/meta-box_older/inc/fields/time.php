 ...
 * Time field class.
 */
class MASHSB_RWMB_Time_Field extends MASHSB_RWMB_Text_Field
{
	/**
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_script( 'rwmb-time', MASHSB_RWMB_JS_URL . 'time.js', array( 'jquery-ui-timepicker-i18n' ), MASHSB_RWMB_VER, true );
		wp_localize_script( 'rwmb-time', 'MASHSB_RWMB_Timepicker', array(
			'locale'      => $locale,
