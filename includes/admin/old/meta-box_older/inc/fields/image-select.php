...
class MASHSB_RWMB_Image_Select_Field extends MASHSB_RWMB_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-image-select', MASHSB_RWMB_CSS_URL . 'image-select.css', array(), MASHSB_RWMB_VER );
		wp_enqueue_script( 'rwmb-image-select', MASHSB_RWMB_JS_URL . 'image-select.js', array( 'jquery' ), MASHSB_RWMB_VER, true );
	}
