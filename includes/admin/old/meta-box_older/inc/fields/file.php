...
class MASHSB_RWMB_File_Field extends MASHSB_RWMB_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-file', MASHSB_RWMB_CSS_URL . 'file.css', array(), MASHSB_RWMB_VER );
		wp_enqueue_script( 'rwmb-file', MASHSB_RWMB_JS_URL . 'file.js', array( 'jquery' ), MASHSB_RWMB_VER, true );
