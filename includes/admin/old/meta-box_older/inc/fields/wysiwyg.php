...
class MASHSB_RWMB_Wysiwyg_Field extends MASHSB_RWMB_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-wysiwyg', MASHSB_RWMB_CSS_URL . 'wysiwyg.css', array(), MASHSB_RWMB_VER );
		wp_enqueue_script( 'rwmb-wysiwyg', MASHSB_RWMB_JS_URL . 'wysiwyg.js', array( 'jquery' ), MASHSB_RWMB_VER, true );
	}
