...
function mashsb_show_update_notice_gdpr() {
    ...
    $message = sprintf(__( '<h2 style="color:white;">MashShare GDPR Compliance</h2>'
        ...
        // admin notice after updating Mashshare
        echo '<div class="mashsb-notice-gdpr mashsb_update_notice_gdpr update-nag" style="background-color: #00abed;color: white;padding: 20px;margin-top: 20px;border: 3px solid white;width:100%;">' . $message .
